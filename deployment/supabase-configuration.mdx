...
-- ─────────────────────────────────────────────
-- 5. RPC: validate 13,000 kg absolute maximum
-- ─────────────────────────────────────────────
...
5. **Weight Validation**: RPC function validates 13,000 kg absolute maximum (frontend enforces 11,500 kg operational limit)
