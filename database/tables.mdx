...
<ParamField path="total_kilos" type="numeric" default="0">
  ...
  **Business rule:** Frontend enforces 11,500 kg limit; database function validates < 13,000 kg as absolute maximum
</ParamField>
...
Validates that an order's total weight is under 13,000 kg (absolute database maximum). Note: The frontend enforces a stricter 11,500 kg limit for operational safety.
